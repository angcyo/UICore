...
open class ClearEditText : AppCompatEditText {
    ...
    private fun initAttribute(context: Context, attrs: AttributeSet?) {
        ...
        showClearDrawable =
            typedArray.getBoolean(R.styleable.ClearEditText_r_show_clear, showClearDrawable)

        isPasswordDrawable = typedArray.getBoolean(
            R.styleable.ClearEditText_r_is_password_drawable,
            isPasswordType()
        )

        showPasswordOnTouch =
            typedArray.getBoolean(
                R.styleable.ClearEditText_r_show_password_on_touch,
                showPasswordOnTouch
            )

        if (typedArray.hasValue(R.styleable.ClearEditText_r_clear_drawable)) {

            clearDrawable =
                typedArray.getDrawable(R.styleable.ClearEditText_r_clear_drawable)
        } else {
