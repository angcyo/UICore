 ...
 */
class SingleMonthView(context: Context) : DefaultMonthView(context) {
    ...
    override fun onDrawText(
        ...
        val textTop = y + mTextBaseLine - textHeight / 4

        if (!isSelected && calendar.isCurrentDay) {
            drawSelected(canvas, x, y, "#2C3C4A".toColor())
        }
