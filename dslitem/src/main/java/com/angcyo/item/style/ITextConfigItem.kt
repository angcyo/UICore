 ...
 */
interface ITextConfigItem : IDslItem {
...
/**初始化*/
fun ITextConfigItem.initTextItem(itemHolder: DslViewHolder) {
...
fun ITextConfigItem.configTextStyle(action: TextStyleConfig.() -> Unit) {
