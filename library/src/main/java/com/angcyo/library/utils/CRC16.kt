...
object CRC16 {
     ...
     */
    fun getTableCRC(data: ByteArray): Int {
        val crc16_table = intArrayOf(
        ...
        var crc = 0
        for (datum in data) {
            crc = crc.shr(8).xor(crc16_table[crc xor datum.toInt() and 0x00ff])
        }
        return crc //String.format("%04X", crc)
    }

    fun getTableCRCHex(data: ByteArray): String {
